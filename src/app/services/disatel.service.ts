...
export class DisatelService {
  ...
  async getOrdenesTrabajoEspeciales<T>( usuario ){
    console.log(`https://pruebas.disatel.app/ROOT/API/API_ot_ver_emergente.php?request=ordenes_especiales&usuario=${usuario}`);
    return this.http.get<T>(`https://pruebas.disatel.app/ROOT/API/API_ot_ver_emergente.php?request=ordenes_especiales&usuario=${usuario}`);
  }
  ...
  async respondeChecklistEmergente<T>(solicitud,vehiculo,valor,pregunta){
    console.log(`https://pruebas.disatel.app/ROOT/API/API_ot_ejecutar_emergente.php?request=responde_checklist&ot=${solicitud}&vehiculo=${vehiculo}&pregunta=${pregunta}&valor=${valor}`)
    return this.http.get<T>(`https://pruebas.disatel.app/ROOT/API/API_ot_ejecutar_emergente.php?request=responde_checklist&ot=${solicitud}&vehiculo=${vehiculo}&pregunta=${pregunta}&valor=${valor}`);
  }
  ...
  async seleccionarSim<T>( ot, vehiculo, sim, fechaHora, equipo ){
    this.datosUsuario = await this.storage.get('datos');
    console.log(`https://pruebas.disatel.app/${disatelEjecutar}selecciona_sim&solicitud=${ot}&sim=${sim}&equipo=${equipo}&vehiculo=${vehiculo}&fecha_hora=${fechaHora}&usuario=${this.datosUsuario.codigo}`);
  ...
  async deseleccionarEquipoE<T>( ot, equipo, fechaHora ){
    this.datosUsuario = await this.storage.get('datos');
    console.log(`https://pruebas.disatel.app/ROOT/API/API_ot_ejecutar_emergente.php?request=desinstalacion_equipo&ot=${ot}&equipo=${equipo}&fecha_hora=${fechaHora}&usuario=${this.datosUsuario.codigo}`);
    return this.http.get<T>(`https://pruebas.disatel.app/ROOT/API/API_ot_ejecutar_emergente.php?request=desinstalacion_equipo&ot=${ot}&equipo=${equipo}&fecha_hora=${fechaHora}&usuario=${this.datosUsuario.codigo}`);
  }

  async desinstalarSim<T>( ot, vehiculo, sim, fechaHora ){
    this.datosUsuario = await this.storage.get('datos');
    console.log(`https://pruebas.disatel.app/${disatelEjecutar}desinstalacion_sim&solicitud=${ot}&sim=${sim}&vehiculo=${vehiculo}&fecha_hora=${fechaHora}&usuario=${this.datosUsuario.codigo}`)
    return this.http.get<T>(`https://pruebas.disatel.app/${disatelEjecutar}desinstalacion_sim&solicitud=${ot}&sim=${sim}&vehiculo=${vehiculo}&fecha_hora=${fechaHora}&usuario=${this.datosUsuario.codigo}`);
  }

  async desinstalarSimE<T>( ot, sim, fechaHora ){
    this.datosUsuario = await this.storage.get('datos');
    console.log(`https://pruebas.disatel.app/ROOT/API/API_ot_ejecutar_emergente.php?request=desinstalacion_sim&ot=${ot}&sim=${sim}&fecha_hora=${fechaHora}&usuario=${this.datosUsuario.codigo}`)
    return this.http.get<T>(`https://pruebas.disatel.app/ROOT/API/API_ot_ejecutar_emergente.php?request=desinstalacion_sim&ot=${ot}&sim=${sim}&fecha_hora=${fechaHora}&usuario=${this.datosUsuario.codigo}`);
  }
  ...
  async postFoto<T>( solicitud, vehiculo, file, titulo ){
    ...
    fd.append('image', file, file.name);
    this.datosUsuario = await this.storage.get('datos');
    console.log(`https://pruebas.disatel.app/${fotoVehiculo}solicitud=${solicitud}&vehiculo=${vehiculo}&titulo=${titulo}&usuario=${this.datosUsuario.codigo}`, fd);
    return this.http.post(`https://pruebas.disatel.app/${fotoVehiculo}solicitud=${solicitud}&vehiculo=${vehiculo}&titulo=${titulo}&usuario=${this.datosUsuario.codigo}`, fd);
  }
  ...
  async postFotoEmergentes<T>( solicitud, vehiculo, file, titulo ){
    ...
    fd.append('image', file, file.name);
    this.datosUsuario = await this.storage.get('datos');
    console.log(`https://pruebas.disatel.app/ROOT/API/API_imagen_emergente.php?ot=${solicitud}&vehiculo=${vehiculo}&titulo=${titulo}&usuario=${this.datosUsuario.codigo}`, fd);
    return this.http.post(`https://pruebas.disatel.app/ROOT/API/API_imagen_emergente.php?ot=${solicitud}&vehiculo=${vehiculo}&titulo=${titulo}&usuario=${this.datosUsuario.codigo}`, fd);
  }
  ...
  async postFotoDispositivo<T>( solicitud, vehiculo, file, titulo ){
    ...
    fd.append('image', file, file.name);
    this.datosUsuario = await this.storage.get('datos');
    console.log(`https://pruebas.disatel.app/${fotoDispositivo}solicitud=${solicitud}&vehiculo=${vehiculo}&titulo=${titulo}&usuario=${this.datosUsuario.codigo}`, fd);
    return this.http.post(`https://pruebas.disatel.app/${fotoDispositivo}solicitud=${solicitud}&vehiculo=${vehiculo}&titulo=${titulo}&usuario=${this.datosUsuario.codigo}`, fd);
  }
  ...
  async postFirma<T>( ot, vehiculo, file){
    ...
    fd.append('image', file, file.name);
    this.datosUsuario = await this.storage.get('datos');
    console.log(`https://pruebas.disatel.app//ROOT/API/API_imagen_vehiculo.php?solicitud=${ot}&vehiculo=${vehiculo}&titulo=11&usuario=${this.datosUsuario.codigo}`, fd);
    return this.http.post(`https://pruebas.disatel.app/ROOT/API/API_imagen_vehiculo.php?solicitud=${ot}&vehiculo=${vehiculo}&titulo=11&usuario=${this.datosUsuario.codigo}`, fd);
  }
  ...
  async postFirmaEmergente<T>( ot, vehiculo, file){
    ...
    fd.append('image', file, file.name);
    this.datosUsuario = await this.storage.get('datos');
    console.log(`https://pruebas.disatel.app//ROOT/API/API_imagen_emergente.php?solicitud=${ot}&vehiculo=${vehiculo}&titulo=11&usuario=${this.datosUsuario.codigo}`, fd);
    return this.http.post(`https://pruebas.disatel.app/ROOT/API/API_imagen_emergente.php?solicitud=${ot}&vehiculo=${vehiculo}&titulo=11&usuario=${this.datosUsuario.codigo}`, fd);
  }
  ...
  async getTitulosImagenesMoviles<T>(){
    this.datosUsuario = await this.storage.get('datos');
    return this.http.get<T>(`https://pruebas.disatel.app/APP/API_ot_ver.php?request=titulos_imagenes_moviles`);
  }

  async getEquiposAIstalar<T>(ot){
    this.datosUsuario = await this.storage.get('datos');
    return this.http.get<T>(`https://pruebas.disatel.app/${disatelUrl}equiposAInstalar&solicitud=${ot}&usuario=${this.datosUsuario.codigo}`);
  }

  async getEquipo<T>(ot, equipo){
    this.datosUsuario = await this.storage.get('datos');
    console.log(`https://pruebas.disatel.app/${disatelUrl}equipos&ot=${ot}&equipo=${equipo}`);
    return this.http.get<T>(`https://pruebas.disatel.app/${disatelUrl}equipos&ot=${ot}&equipo=${equipo}`);
  }

  async getSims<T>(ot){
    this.datosUsuario = await this.storage.get('datos');
    return this.http.get<T>(`https://pruebas.disatel.app/${disatelUrl}simsAInstalar&solicitud=${ot}&usuario=${this.datosUsuario.codigo}`);
  }

  async getSimsSolicitud<T>(ot){
    this.datosUsuario = await this.storage.get('datos');
    return this.http.get<T>(`https://pruebas.disatel.app/${disatelUrl}sims&solicitud=${ot}`);
  }

  async getSim<T>(ot, sim){
    this.datosUsuario = await this.storage.get('datos');
    return this.http.get<T>(`https://pruebas.disatel.app/ROOT/API/API_ot_ver.php?request=get_sim&solicitud=${ot}&sim=${sim}`);
  }

  async getEquiposDestinadosSolicitud<T>(ot){
    this.datosUsuario = await this.storage.get('datos');
    return this.http.get<T>(`https://pruebas.disatel.app/${disatelUrl}equipos&solicitud=${ot}`);
  }
  ...
  async finalizaVisita<T>(ot, reportado, encontrado, solucion, observacion, recibe, internas, fechahora, vehiculo){
    this.datosUsuario = await this.storage.get('datos');
    console.log(`https://pruebas.disatel.app/${disatelEjecutar}finalizarVehiculo&solicitud=${ot}&vehiculo=${vehiculo}&recibe=${recibe}&reportado=${reportado}&encontrado=${encontrado}&solucion=${solucion}&observacion=${observacion}&internas=${internas}&usuario=${this.datosUsuario.codigo}&fecha_hora=${fechahora}`);
    return this.http.get<T>(`https://pruebas.disatel.app/${disatelEjecutar}finalizarVehiculo&solicitud=${ot}&vehiculo=${vehiculo}&recibe=${recibe}&reportado=${reportado}&encontrado=${encontrado}&solucion=${solucion}&observacion=${observacion}&internas=${internas}&usuario=${this.datosUsuario.codigo}&fecha_hora=${fechahora}`);
  }
  ...
  async getEquiposInstalados<T>(ot, vehiculo){
    this.datosUsuario = await this.storage.get('datos');
    console.log(`https://pruebas.disatel.app/${disatelUrl}equipo_instalado&solicitud=${ot}&vehiculo=${vehiculo}`);
    return this.http.get<T>(`https://pruebas.disatel.app/${disatelUrl}equipo_instalado&solicitud=${ot}&vehiculo=${vehiculo}`);
  }
  ...
  async getSedes<T>(){
    return this.http.get<T>('https://pruebas.disatel.app/ROOT/API/API_ot_ver_emergente.php?request=sedes');
  }

  async getClientes<T>(cliente){
    return this.http.get<T>(`https://pruebas.disatel.app/ROOT/API/API_ot_ver_emergente.php?request=clientes&cliente=${cliente}`);
  }

  async getTrabajos<T>(){
    return this.http.get<T>('https://pruebas.disatel.app/ROOT/API/API_ot_ver_emergente.php?request=trabajos');
  }

  async nuevaOtEmergente<T>( sede, cliente, fechaHora, placa, trabajo, justificacion, vehiculo ){
    this.datosUsuario = await this.storage.get('datos');
    console.log(`https://pruebas.disatel.app/${otEmergente}emergente&sede=${sede}&cliente=${cliente}&fecha_hora=${fechaHora}&placa=${placa}&trabajo=${trabajo}&vehiculo=${vehiculo}&justificacion=${justificacion}&usuario=${this.datosUsuario.codigo}`);
    return this.http.get<T>(`https://pruebas.disatel.app/${otEmergente}emergente&sede=${sede}&cliente=${cliente}&fecha_hora=${fechaHora}&placa=${placa}&trabajo=${trabajo}&vehiculo=${vehiculo}&justificacion=${justificacion}&usuario=${this.datosUsuario.codigo}`);
  }

  async otEmergente<T>( ot, vehiculo ){
    console.log(`https://pruebas.disatel.app/ROOT/API/API_ot_ver_emergente.php?request=orden_emergente&ot=${ot}&vehiculo=${vehiculo}`)
    return this.http.get<T>(`https://pruebas.disatel.app/ROOT/API/API_ot_ver_emergente.php?request=orden_emergente&ot=${ot}&vehiculo=${vehiculo}`);
  }

  async getEquiposDisponibles<T>(){
    this.datosUsuario = await this.storage.get('datos');
    return this.http.get<T>(`https://pruebas.disatel.app/ROOT/API/API_ot_ver_emergente.php?request=equipos_disponibles&usuario=${this.datosUsuario.codigo}`);
  } 

  async getSimsDisponibles<T>(){
    this.datosUsuario = await this.storage.get('datos');
    return this.http.get<T>(`https://pruebas.disatel.app/ROOT/API/API_ot_ver_emergente.php?request=sims_disponibles&usuario=${this.datosUsuario.codigo}`);
  } 

  async getChecklistEmergentes<T>(ot){
    this.datosUsuario = await this.storage.get('datos');
    return this.http.get<T>(`https://pruebas.disatel.app/ROOT/API/API_ot_ver_emergente.php?request=checklist&ot=${ot}`);
  }

  async getTitulosImagenesEmergentes<T>(ot){
    this.datosUsuario = await this.storage.get('datos');
    return this.http.get<T>(`https://pruebas.disatel.app/ROOT/API/API_ot_ver_emergente.php?request=titulo_imagenes&ot=${ot}`);
  }

  async iniciaChecklistEmergente<T>(ot,vehiculo,entrega,fechaHora){
    this.datosUsuario = await this.storage.get('datos');
    return this.http.get<T>(`https://pruebas.disatel.app/ROOT/API/API_ot_ejecutar_emergente.php?request=inicia_checklist&ot=${ot}&vehiculo=${vehiculo}&entrega=${entrega}&fecha_hora=${fechaHora}&usuario=${this.datosUsuario.codigo}`);
  }

  async seleccionarEquipoEmergente<T>( ot, vehiculo, equipo, imei, fechaHora, ubicacion ){
    this.datosUsuario = await this.storage.get('datos');
    console.log(`https://pruebas.disatel.app/${otEmergente}selecciona_equipo&ot=${ot}&vehiculo=${vehiculo}&equipo=${equipo}&imei=${imei}&ubicacion=${ubicacion}&fecha_hora=${fechaHora}&usuario=${this.datosUsuario.codigo}`);
    return this.http.get<T>(`https://pruebas.disatel.app/${otEmergente}selecciona_equipo&ot=${ot}&vehiculo=${vehiculo}&equipo=${equipo}&imei=${imei}&ubicacion=${ubicacion}&fecha_hora=${fechaHora}&usuario=${this.datosUsuario.codigo}`);
  }

  async getEquiposInstaladosEmergentes<T>(ot){
    this.datosUsuario = await this.storage.get('datos');
    return this.http.get<T>(`https://pruebas.disatel.app/ROOT/API/API_ot_ver_emergente.php?request=equipo_instalado&ot=${ot}`);
  }

  async iniciaOTEmergente<T>( ot, observaciones, fechaHora ){
    this.datosUsuario = await this.storage.get('datos');
    return this.http.get<T>(`https://pruebas.disatel.app/${otEmergente}inicia_emergente&ot=${ot}&usuario=${this.datosUsuario.codigo}&observaciones=${observaciones}&fecha_hora=${fechaHora}`);
  }

  async finOTEmergente<T>( ot, fechaHora ){
    this.datosUsuario = await this.storage.get('datos');
    return this.http.get<T>(`https://pruebas.disatel.app/${otEmergente}finEmergente&ot=${ot}&usuario=${this.datosUsuario.codigo}&fecha_hora=${fechaHora}`);
  }

  async seleccionarSimEmergente<T>( ot, sim, fechaHora, equipo, linea ){
    this.datosUsuario = await this.storage.get('datos');
    return this.http.get<T>(`https://pruebas.disatel.app/${otEmergente}selecciona_sim&ot=${ot}&sim=${sim}&equipo=${equipo}&linea=${linea}&fecha_hora=${fechaHora}&usuario=${this.datosUsuario.codigo}`);
  }

  async validarPlaca<T>( placa, cliente){
    this.datosUsuario = await this.storage.get('datos');
    return this.http.get<T>(`https://pruebas.disatel.app/ROOT/API/API_ot_ver_emergente.php?request=ver_vehiculo&placa=${placa}&cliente=${cliente}`);
  }

  async equiposAnteriormenteInstalados<T>( vehiculo, ot){
    return this.http.get<T>(`https://pruebas.disatel.app/ROOT/API/API_ot_ver.php?request=equipo_instalado_vehiculo&solicitud=${ot}&vehiculo=${vehiculo}`);
  }

  async getUsuarios<T>(){
    return this.http.get<T>(`https://pruebas.disatel.app/ROOT/API/API_ot_ver.php?request=usuarios_bodega`);
  }

  async entregaBodega<T>( usuarioB, resultado, fechah){
    this.datosUsuario = await this.storage.get('datos');
    console.log(`https://pruebas.disatel.app/ROOT/API/API_ot_ejecutar.php?request=entregar_bodega&usuario_bodega=${usuarioB}&equipos_sims=${resultado}&fecha_hora=${fechah}&usuario=${this.datosUsuario.codigo}`)
    return this.http.get<T>(`https://pruebas.disatel.app/ROOT/API/API_ot_ejecutar.php?request=entregar_bodega&usuario_bodega=${usuarioB}&equipos_sims=${resultado}&fecha_hora=${fechah}&usuario=${this.datosUsuario.codigo}`);
  }

  async escanearDato<T>( tipo, dato, fechah){
    this.datosUsuario = await this.storage.get('datos');
    console.log(`https://pruebas.disatel.app/ROOT/API/API_ot_ejecutar.php?request=escanear_dato&tipo=${tipo}&dato=${dato}&fecha_hora=${fechah}&usuario=${this.datosUsuario.codigo}`)
    return this.http.get<T>(`https://pruebas.disatel.app/ROOT/API/API_ot_ejecutar.php?request=escanear_dato&tipo=${tipo}&dato=${dato}&fecha_hora=${fechah}&usuario=${this.datosUsuario.codigo}`);
  }
  

  async getImagenesSubidas<T>( solicitud, vehiculo ){
    this.datosUsuario = await this.storage.get('datos');
    return this.http.get<T>(`https://pruebas.disatel.app/${disatelUrl}imagenes_vehiculo&solicitud=${solicitud}&vehiculo=${vehiculo}`);
  }
